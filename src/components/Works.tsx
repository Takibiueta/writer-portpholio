  ...
  const works = [
    {
      ...
      year: '2024',
      client: 'TechFlow Inc.',
      description: 'スタートアップ企業のテクノロジーブログシリーズを執筆。AI、ブロックチェーン、IoTなどの最新技術トレンドを分かりやすく解説し、月間PV数を50万から150万に向上させました。',
    ...
    },
    {
      ...
      description: 'ファッションECサイトの商品説明文を全面リニューアル。ブランドの世界観を表現しながら購買欲を喚起するコピーライティングを実施し、コンバージョン率を大幅に改善しました。',
    ...
    },
    {
      ...
      description: 'SaaSツールのSEOコンテンツ戦略を策定・執筆。競合分析から始まり、検索意図に合わせた記事設計により、複数のビッグキーワードで検索順位1位を獲得しました。',
    ...
    },
    {
      ...
      description: '医療従事者向けの専門コンテンツシリーズを企画・執筆。複雑な医療情報を正確かつ分かりやすく伝え、業界内での信頼性とブランド認知度を向上させました。',
    ...
    },
    {
      ...
      description: 'ライフスタイルブランドのストーリーテリングコンテンツを制作。ブランドの価値観とユーザーの感情を結びつける記事により、エンゲージメント率を劇的に向上させました。',
    ...
    },
    {
      ...
      description: 'B2B企業のリードジェネレーションを目的としたコンテンツマーケティング戦略を実施。ホワイトペーパーやケーススタディの制作により、質の高いリードを獲得しました。',
      image: 'https://images.pexels.com/photos/7688115/pexels-photo-7688115.jpeg?auto=compress&cs=tinysrgb&w=800',
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-charcoal/60 text-lg max-w-2xl mx-auto leading-relaxed">
            様々な業界・ジャンルでの執筆実績をご紹介します。それぞれのプロジェクトで異なる課題に対し、
            戦略的なアプローチでコンテンツを制作しています。
          </p>
        </div>
